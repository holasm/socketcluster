 ...
 *
 * Server, Client codes
 * new server is forked on new Server()
 *
 */

// su: this is actually a server container within self._server
var Server = function (options) {
  ...
  // su: create a new com.createServer()
  ...
  // su: handle event: 'listening', 'error', 'brokerMessage'
...
/**
 *
 * Client of Server. Client can be connected to any Server
 * using port and host (used during createClient)
 *
 */
...
var Client = function (options) {
  ...
  // su: automatically connect to Server
  ...
  // su: connect to Server (connect to BrokerServer)
  self._connect();

  // su: this exec command will execute the action on Broker server via actions: {methods...} 
